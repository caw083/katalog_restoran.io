  ...
  async render() {
    return `
            <section class="content">
                <div class="latest">
                    <h1 class="herotitle">Your Favorite Restaurants</h1>
  ...
  async afterRender() {
    try {
      ...
      if (favoriteRestaurants.length > 0) {
        ...
        favoriteListContainer.innerHTML = '<p href="#nofav">No favorite restaurants found.</p>';
        return '<p href="#nofav">No favorite restaurants found.</p>';
      }
    } catch (error) {
